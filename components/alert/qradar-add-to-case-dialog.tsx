...
interface QRadarAddToCaseDialogProps {
  open: boolean
...
export function QRadarAddToCaseDialog({ 
  open, 
  onOpenChange, 
  alertIds, 
  onCaseCreated 
}: QRadarAddToCaseDialogProps) {
  ...
  const handleCreateCase = async () => {
    ...
    setLoading(true)
    try {
      console.log("Submitting QRadar case with:", {
        alertIds,
        caseName,
      ...
      const response = await fetch("/api/qradar/cases", {
        method: "POST",
      ...
      toast({
        title: "Success",
        description: `QRadar case created with ${alertIds.length} alert(s)`,
      })
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          <DialogTitle>Create New QRadar Case</DialogTitle>
          <DialogDescription>
